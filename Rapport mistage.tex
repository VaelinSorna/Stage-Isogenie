...
\begin{document}
	...
	contexte, 2 algo, 
	\section{Méthode étudiée}
	action du groupe de classe, groupe de torsion, marche aléatoire
	\section{Seconde méthode}
	Lemme de Kani, probleme de la N torsion, cas supersingulier
	\newpage
	\printbibliography
