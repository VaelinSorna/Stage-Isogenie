...
\begin{center}
	\textbf{Dans toutes la suite, on suppose que $l$ ne divise pas $pf_{m}|E(\F_{q^{n}})|$ et que $f_{m}$ et $|E(\F_{q^{n}})|$ sont premier entre eux}
\end{center}
...
On se donne un modèle $E$ de corbe elliptique à multiplication complexe définie sur $\F_{q}$, et $\LR$ un idéal de norme $l$ vérifiant toutes les conditions voulues.

\begin{center}
	\textbf{On rappelle que $l$ ne divise pas $pf_{m}|E(\F_{q^{n}})|$ et que $f_{m}$ et $|E(\F_{q^{n}})|$ sont premier entre eux}
\end{center}
