...
\begin{enumerate}
	...
	\item Si on suppose seulement $l$ ne divise pas $f$, on peut tout de même représenter les isogénies horizontales de cette manière mais pas les potentielles descendantes. Si $l$ ne divise pas $f_{m}$ on peut représenter toutes les $l$-isogénies existante.
...
On obtiendra $\LR$ sous forme d'un produit de petit idéaux, mais à un idéal principal prêt. Il faudra trouver un générateur d'un idéal, ce que l'on étudiera en section 7.5.
