...
\begin{Rem}
	Ainsi "$l$ divise $r$" est une "condition d'existence d'ascension", "$l$ divise $f_{m}/f$" est une "condition d'existence de descente" tandis que "$l$ ne divise pas $f$" est une "condition d'existence d'horizontalité". 
\end{Rem}
