...
On présente les résultats d'une expérience menée dans le but de tester sur deux valeurs de $|\Delta|$ laquelle des deux méthodes est la plus efficace. Le fichier TestCLO.ipynb \cite{GITHUBRapportStage} regroupe les codes utilisés pour cette expérience.
